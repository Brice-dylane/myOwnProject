...
<section id="container">
                        ...
                        <div class="adv-table">
                            <table class="table table-striped table-advance table-hover table-bordered" cellpadding="0" cellspacing="0" border="0" id="hidden-table-info">
                                <form>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <h4><i class="fa fa-angle-right"></i> Liste des ventes</h4>
                                        </div>
                                        <div class="col-md-2">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="exampleModalCenterTitle">Nouvelle vente</h2>
    ...
    <div class="modal fade" id="infoCom" tabindex="-1" role="dialog" aria-labelledby="ModalComTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="ModalComTitle">Modifer la vente</h2>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
